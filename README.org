...
* Installation
  ...
  + If it is installed on a local machine (for testing or
    development), add the domain names =qtr.example.org= and
    =l10n.example.org= on ~/etc/hosts~, like this:
    #+BEGIN_EXAMPLE
    127.0.0.1 qtr.example.org
    127.0.0.1 l10n.example.org
    #+END_EXAMPLE
    This way it can be accessed by typing =https://qtr.example.org=
...
* Quick install
  ...
  *NOTE:* Although [[https://github.com/B-Translator/qtr_server/blob/master/utils/docker-install.sh][utils/docker-install.sh]] is handy for making a quick
...
* Change configuration
  ...
  #+END_EXAMPLE
  These scripts can be found on [[https://github.com/B-Translator/qtr_server/tree/master/install/config][install/config/]].
...
* Import projects
  ...
  more details see: [[https://github.com/B-Translator/qtr_server/blob/master/modules/custom/qtrCore/data/README.org][/var/www/data/README.org]]
...
* Contacts
  ...
  - Misc
    ...
    + Wiki: https://github.com/B-Translator/qtr_server/wiki
    + Issues: https://github.com/B-Translator/qtr_server/issues
