...
* Translation files
  ...
  the scripts in the directory [[https://github.com/B-Translator/qtr_server/tree/master/modules/custom/qtrCore/data/get][get/]], which checkout (or update)
  ...
  =$data_root=, which is defined in [[https://github.com/B-Translator/qtr_server/blob/master/modules/custom/qtrCore/data/config.sh][config.sh]]. Besides =$data_root=,
...
** Import scripts
   ...
   The scripts in the directory [[https://github.com/B-Translator/qtr_server/tree/master/modules/custom/qtrCore/data/import][import/]] are used to import projects
...
** Example script
   ...
   [[https://github.com/B-Translator/qtr_server/blob/master/modules/custom/qtrCore/data/import/pingus.sh][This]] is a simple script for importing the =Pingus= project:
   #+BEGIN_EXAMPLE
   #!/bin/bash -x
...
** Getting diffs from the web (wget_diff.sh)
   ...
   A script [[https://github.com/B-Translator/qtr_server/blob/master/modules/custom/qtrCore/data/utils/wget-diffs.sh][like this]] can be used by the translators to get the diffs of the
