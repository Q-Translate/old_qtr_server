DROP TABLE IF EXISTS `qtr_diffs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_diffs` (
...
DROP TABLE IF EXISTS `qtr_snapshots`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_snapshots` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_files` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_projects` (
  `pguid` char(40) CHARACTER SET ascii NOT NULL COMMENT 'Project Globally Unique ID, pguid = SHA1(CONCAT(origin,project))',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_templates` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_locations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_locations` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_strings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_strings` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_votes_trash`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_votes_trash` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_user_project_roles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_user_project_roles` (
  `umail` varchar(250) NOT NULL COMMENT 'Email of the user.',
  `ulng` varchar(5) NOT NULL COMMENT 'Translation language of the user.',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `qtr_mv_sample`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qtr_mv_sample` (
