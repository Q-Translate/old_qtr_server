...
function sguid_get($target, $lng =NULL, $projects =NULL) {
  ...
  switch ($target) {
    default:
    case 'random':
      $sguid = qtr::sguid_get_random($uid=NULL, $projects);
      break;
    case 'translated':
      $sguid = qtr::sguid_get_translated($lng, $uid=NULL, $projects);
      break;
    case 'untranslated':
      $sguid = qtr::sguid_get_untranslated($lng, $uid=NULL, $projects);
      break;
  }
