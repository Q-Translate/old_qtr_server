 ...
 */
function qtr_server_pager_previous($variables) {
 ...
 */
function qtr_server_pager_next($variables) {
 ...
 */
function qtr_server_pager_first($variables) {
 ...
 */
function qtr_server_pager_last($variables) {
